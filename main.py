        ...
        if projects_response is not None and projects_response.status_code == 200:
            ...
            for project in projects:
                ...
                if key_response is not None and key_response.status_code == 200:
                    ...
                    payload = {
                        "rateLimit" : {
                            "window" : os.environ["RATELIMIT_WINDOW"],
                    ...
                    print(f'Could not find keys for project {project["slug"]}')
        else:
            print(f'Could not fetch projects for org {os.environ["ORG_SLUG"]}')
